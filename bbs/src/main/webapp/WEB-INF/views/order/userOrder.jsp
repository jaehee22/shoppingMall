...
<%	
	int userOrderNum = Integer.parseInt(request.getParameter("userOrderNum"));     
%>

	<c:set var="userOrderNum" value="<%=userOrderNum%>"/> <!-- 주문 번호 -->
	<!-- Bootstrap core CSS -->
...
<body>
		...
		<div class="row">
			...
			<br><form name="checkBoxForm">
					<table class="table" style="text-align:center;">
						...
						<input type="hidden" id="userOrderNum" name="userOrderNum" value="${userOrderNum}"/> <!-- 페이지 -->
				</form>
				<br>
				<!-- 페이징 -->
	...
	<script src="${pageContext.request.contextPath}/resources/js/userOrder.js"></script>
</body>
