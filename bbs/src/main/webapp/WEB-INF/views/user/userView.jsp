...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
         ...
         <c:if test="${userForm != null }">
          	<li class="nav-item">
            	<a class="nav-link" href="/user/userProfile">내정보</a>
          	</li>
          	<li class="nav-item">
  ...
  <div class="container">
    ...
    <div class="row">
	  ...
	  <div class="col-lg-9">
      	...
      	<br>
      		<h4 style="text-align:center">내정보</h4>
      	<br>
  ...
  <script src="${pageContext.request.contextPath}/resources/js/userView.js"></script>
